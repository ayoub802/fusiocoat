        ...
        <div className='mt-[88px] lg:mt-[98px]'>
            ...
            <section className='bg-white'>
                <div className="container">
                  <h3 class="font-bold text__48 mb-8">FC – AÉRO : Le Pionnier de la Protection Esthétique des
                    <br class="hidden sm:block" /> 
                    Avions de Loisirs et Sports Aériens
                  </h3>
                  <p class="text__18 mb-8 text-[#525252]">
                  ...
                  <p class="text__18 mb-8 mt-4 text-[#525252]">
                  ...
                  <div className='row mt-5 items-center'>
                      <div className="col-md-9">
                        <h3 class="font-bold text-[18px] mb-2 text-black">Pourquoi utiliser FC-AÉRO</h3>
                      ...
                      <div className="col-md-3">
                        <img src={Aero} className='w-[350px] h-[400px]'/>
                      </div>
                  </div>
